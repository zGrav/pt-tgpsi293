...
//public code - http://bsim-bccs.sourceforge.net/docs/javadoc/bsim/export/quicktime/QuickTimeOutputStream.html
...
public class qtStream {
    ...
    private class CompositeAtom extends Atom {
        ...
        public void finish() throws IOException {
            if (!finished) {
                ...
                dataOutput headerData = new dataOutput(new filterOutput(out));
    ...
    protected class DataAtom extends Atom {
        ...
        public DataAtom(String name) throws IOException {
            super(name);
            out.writeLong(0); // make room for the atom header
            data = new dataOutput(new filterOutput(out));
        }
     ...
     * framerate is <= 0
     */
    public qtStream(File file, VideoFormat format) throws IOException {
        if (file.exists()) {
            file.delete();
        }
    ...
    private void writeProlog() throws IOException {
        ...
        dataOutput d = ftypAtom.getOutputStream();
    ...
    private void writeEpilog() throws IOException {
        ...
        moovAtom.add(leaf);
        dataOutput d = leaf.getOutputStream();
