<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="Aula22_01.Main1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="style1">
        ...
        <tr>
            <td>
                <asp:Button ID="btnFriends" runat="server" Text="Friends" 
                    onclick="btnFriends_Click" />
            </td>
            <td>
                Wins:
